...
const db = mysql.createConnection({
  host: 'bxtqgvlykbnxxodzkz9s-mysql.services.clever-cloud.com',
  user: 'uxiguuarqwxzyzpt',
  password: 'GCTmNpYeWouba0veyWZE',
  database: 'bxtqgvlykbnxxodzkz9s',
  port: '3306',
});
...
app.listen(PORT, () => {
  console.log(`Server is running at http://155.138.219.54:${PORT}`);
});